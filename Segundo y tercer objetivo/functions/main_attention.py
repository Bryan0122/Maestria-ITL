...
def attention_wide(modelw,rel_model_name,layer_name,X_train,y_train,
  ...
  # generate heatmap with GradCAM
      if (rel_model_name == 'Gradcam') or (rel_model_name == 'Gradcam++'):
        ...
        rel = saliencyw([score, score], new_input,smooth_samples=smooth_samples,
        ...
        rel = scorecamw([score, score], new_input, penultimate_layer=layer_name[l], #layer to be analized
                    expand_cam=True,
